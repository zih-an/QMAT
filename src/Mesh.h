//
// Created by 27665 on 2024/7/23.
//

#ifndef QMAT_SIMPLIFY_MESH_H
#define QMAT_SIMPLIFY_MESH_H
...
#include <CGAL/Delaunay_triangulation_cell_base_with_circumcenter_3.h> // zihan
#include <CGAL/Triangulation_vertex_base_3.h>  // zihan
...
typedef CGAL::Triangulation_vertex_base_3<K> Vbase;   // zihan
typedef CGAL::Triangulation_vertex_base_with_info_3<VertexInfo, K, Vbase> Vb;   // zihan
// Define the cell base with circumcenter and additional info
typedef CGAL::Delaunay_triangulation_cell_base_3<K> Cbbase;
typedef CGAL::Delaunay_triangulation_cell_base_with_circumcenter_3<K, Cbbase> Cbase;  // For circumcenter()  // zihan
typedef CGAL::Triangulation_cell_base_with_info_3<CellInfo, K, Cbase> Cb;   // zihan
...
public:
    ...
    bool isCoverageAxis = false; //coverageaxis - zihan
