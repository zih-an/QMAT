...
#ifndef QMAT_SIMPLIFY_NONMANIFOLDMESH_H
#define QMAT_SIMPLIFY_NONMANIFOLDMESH_H
...
public:
    ...
    void Export_vor_pts(std::string fname);  //for coverageaxis
...
#endif //QMAT_SIMPLIFY_NONMANIFOLDMESH_H
