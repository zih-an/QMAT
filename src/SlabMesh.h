...
public:
    ...
    void Simplify_with_Selected_Pole(
        int threshold,
    ...
    void EvaluateEdgeCollapseCost_coverageaxis(unsigned eid); //coverageAxis

    bool isCoverageAxis = false;
